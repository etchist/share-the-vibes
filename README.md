...
## UI Improvements (June 2024)

- The story input on the submit page uses Mantine's RichTextEditor for a modern, accessible editing experience.
- The tags input now uses Mantine's TagsInput component, supporting suggestions, max tags, and full theme consistency.
- The custom TagInput component has been removed.
- Tag suggestions are fetched live from the backend as you type.
